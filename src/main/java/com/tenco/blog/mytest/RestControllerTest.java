...
public class RestControllerTest {
    ...
    // 테스트 주소
    // 웹 브라우저 주소창에 시작
    // 테스트 주소 (우리 도메인에서 요청 주소는 http://localhost:8080/todos/3 보낼 예정)
    ...
    public String test1(@PathVariable(name = "id") Integer id) {
        ...
        ResponseEntity<String > responseMessage = template1.exchange(
    ...
    public ResponseEntity<PostDTO> test2() {
        ...
        HttpEntity request = new HttpEntity(postDTO, headers);
